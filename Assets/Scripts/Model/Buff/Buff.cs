...
public class CorrodeBuff : Buff
{
    ...
    public CorrodeBuff() : base("腐蚀", "造成伤害下降20%", BuffType.AfterPutCard)
    {
    }
...
public class FragileBuff : Buff
{
    ...
    public FragileBuff() : base("脆弱", "受到伤害增加20%", BuffType.AfterPutCard)
    {
...
public class WearyBuff : Buff
{
    ...
    public WearyBuff() : base("疲惫", "费用上限-1", BuffType.AfterPutCard)
    {
...
public class InciteBuff : Buff
{
    ...
    public InciteBuff() : base("躁动", "每打出一张非红色牌，将一张怒火加入手牌", BuffType.AfterPutCard)
    {
...
{
    public DizzyBuff() : base("眩晕", "无法抽牌", BuffType.AfterPutCard)
    {
...
{
    public VigourBuff() : base("活力", "回合开始多抽1张牌", BuffType.AfterPutCard)
    {
...
{
    public PowerfulBuff() : base("强力", "造成伤害增加20%", BuffType.AfterPutCard)
    {
...
{
    public ProvokeBuff() : base("挑衅", "本回合中卡牌伤害翻倍", BuffType.AfterPutCard)
    {
...
{
    public IncreaseBuff() : base("改进", "在本局游戏中，每回合开始时，减少5点血量，获得*点护甲", BuffType.AfterPutCard)
    {
...
{
    public ComfortBuff() : base("安抚", "每使用一张卡牌，回复15点血量", BuffType.AfterPutCard)
    {
